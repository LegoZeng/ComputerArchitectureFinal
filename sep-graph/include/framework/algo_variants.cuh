...
namespace sepgraph
{
        namespace engine
        {
                                          ...
                                          const groute::Stream &stream)
                {
                        ...
                        graph_datum.m_wl_array_in.ResetAsync(stream.cuda_stream);
                                             ...
                                             const groute::Stream &stream)
                {
                        ...
                        kernel::Sample<<<grid_dims, block_dims, 0, stream.cuda_stream>>>(groute::dev::WorkSourceArray<index_t>(
                                   ...
                                   const groute::Stream &stream)
                {
                        ...
                        kernel::common::CombineValueBuffer<<<grid_dims, block_dims, 0, stream.cuda_stream>>>(app_inst,
                                                                                                             graph_datum.GetWorkSourceRangeDeviceObject(),
